...
{
	setupLanzador();
	//flancos_detectados = 0xFF; // para la simulacion de los flancos
			...
			case JUEGO:
				...
				if(estado_actual_cabeceo == LISTO_CABECEO){
					...
					if(estado_actual_disparo == LISTO_DISPARO){
						//flancos_detectados = 0xFF; // para la simulacion de flancos
						_delay_ms(2000); // comentado para simulacion
