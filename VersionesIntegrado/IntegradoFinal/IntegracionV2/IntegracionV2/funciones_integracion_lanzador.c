...
volatile uint8_t init_cont_cargar_disparo = 0;
volatile uint8_t cont_cargar_disparo = 0;

void timeoutCargarLanzador(){
	if(init_cont_cargar_disparo){ cont_cargar_disparo++; }
}
...
void setupFlagsLanzador(){
	direccion = 0;
	iniciado = 0;
	flag_preparado_carga = 0;
	flag_disparo_listo = 0;
	flag_preparado_cabeceo = 0;
